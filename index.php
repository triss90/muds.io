    ...
    <div class="container">
        ...
        <div class="row">
            <div class="tiny-12 center-tiny">
                ...
                <br>
                <br>
                <a href="/download/muds-editor-v1.1.1.zip" class="button primary" download><i class="fa fa-download" aria-hidden="true"></i> Download</a>
...
&#x3C;/script&#x3E;
                ...
                <p>Or install the library with NPM: <span class="tag">npm i muds-editor</span></p><br>
