    ...
    <div class="container">
        <div class="row">
            <div class="tiny-12 center-tiny">
                <h1>MRKDWN, <i>the</i> lightest WYSIWYG Editor</h1>
                ...
                <a href="#0" class="button secondary">Visit GitHub</a>
                <br><br><br><br>
                <div id="editor"></div>
            </div>
        </div>
...
<section id="demo">
    <div class="container">
        <div class="row center-tiny">
            <div class="tiny-12">
                <h2>How to use mrkdwn editor</h2>
            </div>
        </div>
        <div class="row center-tiny">
...
<span class="c4">&lt;!-- Include the mrkdwn library --></span>
...
<span class="c4">&lt;!-- Initialize mrkdwn editor --></span>
<span class="c1">&lt;script</span>
<span class="c5">var</span> <span class="c6">editor =</span> <span class="c5">new</span> <span class="c2">mrkdwn</span><span class="c6">({</span>
...
<span class="c1">&lt;/script></span></pre>
            ...
            <div class="tiny-12 small-5 medium-6 large-6">
                <pre class="code"><span class="c4">/* Initialize mrkdwn editor */</span>
<span class="c5">var</span> <span class="c6">editor =</span> <span class="c5">new</span> <span class="c2">mrkdwn</span><span class="c6">({</span>
