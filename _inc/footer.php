    ...
    <div class="container">
        <div class="row center-tiny">
            <div class="tiny-12">
                ...
                <a href="/download/muds-editor-v1.3.1.zip" class="button primary big" download><i class="fa fa-download" aria-hidden="true"></i> Download v1.3.1</a>
                <br><br><br>
...
<script src="https://cdn.jsdelivr.net/npm/muds-editor@1.3.1/muds.min.js"></script>
