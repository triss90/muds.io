(function(){
    ...
    var mrkdwn = function(opts) {
        this.options = Object.assign(mrkdwn.defaults, opts);
    ...
    // Menu Actions
    mrkdwn.prototype.enterFullScreen = function(string) {
        const content = this.orignal_input.querySelector('.mrkdwn-content');
        const toolbarButton = this.orignal_input.querySelector('.mrkdwn-toolbar .mrkdwn-item.fullscreen')
        this.orignal_input.querySelector('.mrkdwn-content');
    ...
    mrkdwn.prototype.exitFullScreen = function(string) {
        const content = this.orignal_input.querySelector('.mrkdwn-content');
        const toolbarButton = this.orignal_input.querySelector('.mrkdwn-toolbar .mrkdwn-item.fullscreen');
    ...
    mrkdwn.prototype.buttonH1Action = function(string) {
        document.execCommand('formatBlock', false, 'h1');
    };
    mrkdwn.prototype.buttonH2Action = function(string) {
        document.execCommand('formatBlock', false, 'h2');
    };
    mrkdwn.prototype.buttonH3Action = function(string) {
        document.execCommand('formatBlock', false, 'h3');
    };
    mrkdwn.prototype.buttonUnorderedListAction = function(string) {
        document.execCommand('insertUnorderedList', false, '');
    };
    mrkdwn.prototype.buttonOrderedListAction = function(string) {
        document.execCommand('insertOrderedList', false, '');
    };
    mrkdwn.prototype.buttonUnderlineAction = function(string) {
        document.execCommand('underline', false, '');
    };
    mrkdwn.prototype.buttonItalicAction = function(string) {
        document.execCommand('italic', false, '');
    };
    mrkdwn.prototype.buttonBoldAction = function(string) {
        document.execCommand('bold', false, '');
    };
    mrkdwn.prototype.buttonLinkAction = function(string) {
        const linkURL = prompt('Enter the URL');
        document.execCommand('createLink', false, linkURL);
    };
    mrkdwn.prototype.buttonCutAction = function(string) {
        document.execCommand('cut',false,'');
    };
    mrkdwn.prototype.buttonCopyAction = function(string) {
        document.execCommand('copy', false, '');
    };
    mrkdwn.prototype.buttonUndoAction = function(string) {
        document.execCommand('undo',false,'');
    };
    mrkdwn.prototype.buttonRedoAction = function(string) {
        document.execCommand('redo',false,'');
    };
    mrkdwn.prototype.buttonChangeColorAction = function(string) {
        const color = prompt('Enter your color in hex ex: #f1f233');
        document.execCommand('foreColor', false, color);
    };
    mrkdwn.prototype.buttonGetImageAction = function(string) {
        const editorContent = document.querySelector('.mrkdwn-content');
    ...
    mrkdwn.prototype.buttonStrikeThroughAction = function(string) {
        document.execCommand('strikeThrough',false,'');
    };
    mrkdwn.prototype.buttonDeleteAction = function(string) {
        document.execCommand('delete',false,'');
    };
    mrkdwn.prototype.buttonSelectAllAction = function(string) {
        const editorContent = document.querySelector(".mrkdwn-content");
    ...
    mrkdwn.prototype.buttonJustifyCenterAction = function(string) {
        document.execCommand('justifyCenter',false,'');
    };
    mrkdwn.prototype.buttonJustifyLeftAction = function(string) {
        document.execCommand('justifyLeft',false,'')
    };
    mrkdwn.prototype.buttonJustifyRightAction = function(string) {
        document.execCommand('justifyRight',false,'')
    };
    mrkdwn.prototype.buttonShowHTMLAction = function(string) {
        const editorContent = document.querySelector(".mrkdwn-content");
        const htmlCode = editorContent.innerHTML;
        const myWindow = window.open("", "MRKDWN - View HTML", "width=768,height=600");
        myWindow.document.write('<html><head><title>MRKDWN - View HTML</title><style>html,body{margin:0;padding:0;}pre{height:100%;}</style></head><body>');
    ...
    function buttonFullScreen(item) {
        ...
        buttonFullScreen.classList.add('mrkdwn-item','fullscreen');
    ...
    function buttonHeader(item) {
        ...
        buttonHeader.classList.add('mrkdwn-dropdown');
        buttonHeader.innerHTML = '<label><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0V0z"/><path d="M5 4v3h5.5v12h3V7H19V4H5z"/></svg></label>' +
            '<ul>' +
            '<li><button class="mrkdwn-h1" title="Healine 1" onclick="'+item.orignal_input.id + '.buttonH1Action()'+'">Header 1</button></li>' +
            '<li><button class="mrkdwn-h2" title="Healine 2" onclick="'+item.orignal_input.id + '.buttonH2Action()'+'">Header 2</button></li>' +
            '<li><button class="mrkdwn-h3" title="Healine 3" onclick="'+item.orignal_input.id + '.buttonH3Action()'+'">Header 3</button></li>' +
            '</ul>';
    ...
    function buttonUnorderedList(item) {
        ...
        buttonUnorderedList.classList.add('mrkdwn-item');
    ...
    function buttonOrderedList(item) {
        ...
        buttonOrderedList.classList.add('mrkdwn-item');
    ...
    function buttonUnderline(item) {
        ...
        buttonUnderline.classList.add('mrkdwn-item');
    ...
    function buttonItalic(item) {
        ...
        buttonItalic.classList.add('mrkdwn-item');
    ...
    function buttonBold(item) {
        ...
        buttonBold.classList.add('mrkdwn-item');
    ...
    function buttonLink(item) {
        ...
        buttonLink.classList.add('mrkdwn-item');
    ...
    function buttonCut(item) {
        ...
        buttonCut.classList.add('mrkdwn-item');
    ...
    function copy(item) {
        ...
        copy.classList.add('mrkdwn-item');
    ...
    function buttonUndo(item) {
        ...
        buttonUndo.classList.add('mrkdwn-item');
    ...
    function buttonRedo(item) {
        ...
        buttonRedo.classList.add('mrkdwn-item');
    ...
    function changeColor(item) {
        ...
        changeColor.classList.add('mrkdwn-item');
    ...
    function getImage(item) {
        ...
        imageInput.classList.add('mrkdwn-item');
        ...
        imageLabel.classList.add('mrkdwn-item');
    ...
    function strikeThrough(item) {
        ...
        strikeThrough.classList.add('mrkdwn-item');
    ...
    function deletes(item) {
        ...
        deletes.classList.add('mrkdwn-item');
    ...
    function selectAll(item) {
        ...
        selectAll.classList.add('mrkdwn-item');
    ...
    function justifyCenter(item) {
        ...
        justifyCenter.classList.add('mrkdwn-item');
    ...
    function justifyLeft(item) {
        ...
        justifyLeft.classList.add('mrkdwn-item');
    ...
    function justifyRight(item) {
        ...
        justifyRight.classList.add('mrkdwn-item');
    ...
    function printMe(item) {
        ...
        printMe.classList.add('mrkdwn-item');
    ...
    function showHTML(item) {
        ...
        showHTML.classList.add('mrkdwn-item');
    ...
    function showText(item) {
        ...
        showText.classList.add('mrkdwn-item');
    ...
    function buildEditor(editor) {
        const mrkdwnToolElement = editor.menu;
        mrkdwnToolElement.classList.add('mrkdwn-toolbar');
        const mrkdwnContentElement = editor.content;
        mrkdwnContentElement.classList.add('mrkdwn-content');
        mrkdwnContentElement.setAttribute('contenteditable','true');
        mrkdwnContentElement.style.resize = 'vertical';
        mrkdwnContentElement.style.overflow = 'auto';
        mrkdwnContentElement.style.height = editor.height;
        if (editor.text !== undefined) { mrkdwnContentElement.innerHTML = editor.text; }
        const mrkdwnOutputElement = editor.output;
        mrkdwnOutputElement.classList.add('mrkdwn-output');
        editor.orignal_input.appendChild(mrkdwnToolElement);
        editor.orignal_input.appendChild(mrkdwnContentElement);
        editor.orignal_input.appendChild(mrkdwnOutputElement);
    }
